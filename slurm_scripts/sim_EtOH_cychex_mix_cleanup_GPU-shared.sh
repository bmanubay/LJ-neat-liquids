...
"""
python run_molecule_cleanup.py cyclohexane C1CCCCC1 250 [#6X4:1] epsilon rmin_half 0.1094 1.9080 &
python run_molecule_cleanup.py cyclohexane C1CCCCC1 250 [#6X4:1] epsilon rmin_half 0.15 1.9080 &
python run_molecule_cleanup.py cyclohexane C1CCCCC1 250 [#6X4:1] epsilon rmin_half 0.05 1.9080 &
python run_molecule_cleanup.py cyclohexane C1CCCCC1 250 [#6X4:1] epsilon rmin_half 0.1094 1.5 &
wait
